                ...
                <form action="" method="post">
                    ...
                    <div class="card-body">
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
                                    <p class="fw-bold mb-0">@lang('Video Ads show for subscription user')</p>
                                    <p class="mb-0">
                                        <small>@lang('If you enable this module, the subscription users will see ads while the video is playing')</small>
                                    </p>
                                </div>
                                <div class="form-group">
                                    <input name="video_ad_subscription_user" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" type="checkbox" @if ($general->video_ad_subscription_user) checked @endif>
                                </div>
                            </li>
                            <li class="list-group-item d-flex flex-sm-nowrap justify-content-between align-items-center flex-wrap gap-2">
                                <div>
