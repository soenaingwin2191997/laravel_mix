        ...
        <div class="col-lg-12">
            <div class="card mt-3">
                <div class="card-body">
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <video class="video-js" id="my-video" data-setup="{}" controls preload="auto" width="100%" height="264" poster="{{ getImage(getFilePath('item_landscape') . '/' . @$item->image->landscape) }}" controlsList="nodownload">
    ...
    <script>
        (function() {
            ...
            $(video).on('timeupdate', function(e) {
                var updatedTime = Math.floor(video.currentTime);
