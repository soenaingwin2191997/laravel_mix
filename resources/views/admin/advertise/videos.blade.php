                                ...
                                @forelse($ads as $ad)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                @if ($ad->server == 0)
                                                    <a href="{{ getImage(getFilePath('ads') . '/' . $ad->content->video) }}" target="_blank">{{ getImage(getFilePath('ads') . '/' . $ad->content->video) }}</a>
                                                @elseif($ad->server == 1)
                                                    <a href="{{ $general->ftp->domain . '/' . $ad->content->video }}" target="_blank">{{ $general->ftp->domain . '/' . $ad->content->video }}</a>
                                                @elseif($ad->server == 3)
                                                    <a href="{{ @$general->wasabi->endpoint . '/' . @$general->wasabi->bucket . '/' . @$ad->content->video }}">{{ @$general->wasabi->endpoint . '/' . @$general->wasabi->bucket . '/' . @$ad->content->video }}</a>
                                                @endif
                                            @endif
                                        </td>
