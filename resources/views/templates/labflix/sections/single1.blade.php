        ...
        <div class="row align-items-center">
            <div class="col-xl-5 col-lg-6">
                <div class="single-movie-thumb">
                    ...
                    @if (@$single[0])
                        <a class="video-btn" href="{{ route('watch', @$single[0]->id) }}">
                            <div class="icon">
                ...
                <div class="single-movie-content">
                    ...
                    @if (@$single[0])
                        @if (@$single[0]->item_type == 3)
                            <a class="cmn-btn mt-4" href="{{ route('watch', @$single[0]->id) }}">@lang('Watch Trailer')</a>
                        @else
                            <a class="cmn-btn mt-4" href="{{ route('watch', @$single[0]->id) }}">@lang('Watch Now')</a>
                        @endif
                    @endif
                </div>
            </div>
