        ...
        <div class="row gy-3">
                    ...
                    @foreach ($trendings as $trending)
                        <li class="movie-small">
                            ...
                            <div class="movie-small__content">
                                ...
                                <a class="text-small base--color" href="{{ route('watch', $trending->id) }}">
                    ...
                    @foreach ($topRateds as $topRated)
                        <li class="movie-small">
                            ...
                            <div class="movie-small__content">
                                ...
                                <a class="text-small base--color" href="{{ route('watch', $topRated->id) }}">
            ...
            <div class="col-xxl-6 col-xl-4">
                <div class="single-movie">
                    ...
                    @if (@$mostViewsTrailer)
                        <a class="video-btn" href="{{ route('watch', @$mostViewsTrailer->id) }}">
                            <div class="icon">
