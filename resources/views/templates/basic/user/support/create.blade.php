                            ...
                            <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    <div class="form-group col-md-6">
                                        ...
                                        <input class="form--control form-control-lg" name="name" type="text" value="{{ @$user->firstname . ' ' . @$user->lastname }}" placeholder="@lang('Enter your name')" readonly>
                                    </div>
                                    <div class="form-group col-md-6">
                                        <label for="email">@lang('Email address')</label>
                                        <input class="form--control form-control-lg" name="email" type="email" value="{{ @$user->email }}" placeholder="@lang('Enter your email')" readonly>
                                    </div>
